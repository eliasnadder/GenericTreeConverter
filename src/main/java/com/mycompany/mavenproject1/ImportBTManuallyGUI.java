...
public class ImportBTManuallyGUI extends JFrame implements ActionListener {
    ...
    public ImportBTManuallyGUI() {
        ...
        printToFileButton = new JButton("Export Generic Tree to File");
        printToFileButton.addActionListener(this);
        printToFileButton.setVisible(false);
    ...
    public void convertMethod() {
        ...
        if (binaryRoot != null) {
            ...
            printToFileButton.setVisible(true);
        }
    }
    ...
    private void printToFileMethod() {
        ...
        fileChooser.setSelectedFile(new File("outputGT.txt"));

        int userSelection = fileChooser.showSaveDialog(this);
        if (userSelection == JFileChooser.APPROVE_OPTION) {
            File fileToSave = fileChooser.getSelectedFile();
            if (fileToSave.getName().endsWith(".txt")) {
                Methods.exportGTToFile(generalNode, fileToSave);
                String[] options = { "OK" };
    ...
    public void printGTMethod() {
        if (genericTree == null) {
            ...
            SwingUtilities.invokeLater(() -> {
                PrintGenericTreeOptions printGenericTreeOptions = new PrintGenericTreeOptions();
                printGenericTreeOptions.setLocationRelativeTo(null);
                printGenericTreeOptions.setGenericTree(genericTree);
                printGenericTreeOptions.setVisible(true);
            });
        }
    }
